...
const phrases = [
  "Azure OpenAI agentic platforms",
  "RAG pipelines over enterprise data",
  "MCP tool servers and integration gateways",
  "human-in-the-loop review workflows",
  "Azure DevOps paths from design to production"
];
...
function animateNumber(element) {
  ...
  function tick(now) {
    ...
    element.textContent = current.toLocaleString(undefined, {
      ...
      minimumFractionDigits: target === 99.9 ? 1 : 0
    });
